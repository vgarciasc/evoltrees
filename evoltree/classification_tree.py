...
class ClassificationTree(Tree):
    ...
    def copy(self):
        return ClassificationTree(self.config, self.depth,
    ...
    def generate_random(config, depth, params={}, X=None):
        ...
        fitness_fn = params.get("fitness_fn", calc_accuracy)
        ...
        return ClassificationTree(config, depth, attributes, thresholds, labels, fitness_fn)
